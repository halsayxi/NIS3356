...
from Sound_Shape_Code.four_corner import FourCornerMethod
...
def getHanziStrokesDict():
    strokes_filepath = pkg_resources.resource_filename(__name__, "data/utf8_strokes.txt")
...
def getHanziStructureDict():
    structure_filepath = pkg_resources.resource_filename(__name__, "data/unihan_structure.txt")
...
def generateHanziSSCFile(): 
    readFilePath = pkg_resources.resource_filename(__name__, "data/unihan_structure.txt")
    writeFilePath = pkg_resources.resource_filename(__name__, "data/hanzi_ssc_res.txt")
...
def getHanziSSCDict():
    hanzi_ssc_filepath = pkg_resources.resource_filename(__name__, "data/hanzi_ssc_res.txt")
